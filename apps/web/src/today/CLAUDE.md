...
| `NewLessonCard.tsx` | Real new-lesson row — calls the `next_new_lesson` RPC (ADR 0012), renders "Begin page N" / "Continue page N" with surah label, falls back to a hifz-complete empty state | Touching the Today new-lesson UX |
